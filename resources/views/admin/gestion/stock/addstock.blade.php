            ...
            <div class="card-body bg-dark">
                ...
                <form method="POST" action="{{ route('stocks.store') }}">
                    ...
                    <div id="form-container">
                        ...
                        <div class="form-section" data-index="0">
                            <div class="row" id="stock-form-container">
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-3">
                                        <label class="form-label">choix l'élément</label>
                                        <select style="background-color:black" class="form-control" name="stocks[0][category]" id="categorie_stock">
                    ...
                    <div> <button type="button" class="btn btn-secondary" id="add-more"><i class="link-icon" data-feather="plus-circle"></i> Ajouter autre élément</button>
                        <button type="button" class="btn btn-danger remove-section" id="remove-last">Supprimer le dernier élément</button>
    </div>
...
function populateCategories() {
    ...
    for (const [groupName, categories] of Object.entries(groupedCategories)) {
        ...
        categories.forEach(category => {
            ...
            option.style.backgroundColor = "#060C17";
